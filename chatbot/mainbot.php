...
<body>
    <div id="container" class= "teste">
        <div id="screen">
            <div id="header">GDC ACESSIBILIDADE</div>
            <div id="messageDisplaySection">
        
        </div>
            <!-- messages input field -->
            <div id="userInput">
                <input type="text" name="messages" id="messages" autocomplete="OFF" placeholder="Escreva Olá para começar." required>
                <input type="submit" value="Send" id="send" name="Enviar">
            </div>
        </div>
    </div>
